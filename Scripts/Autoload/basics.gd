...
enum ABILITY_ERROR {OK, IN_COOLDOWN, UNAVAILABLE, NEED_RESOURCE, SCRIPT_ERROR}
...
"souls" : preload("res://Ressources/Stats/Souls.tres")}

var decorations_models = [preload("res://Scenes/Models/tribal_sanctuary_round_model.tscn"), \
preload("res://Scenes/Models/skull_model.tscn"), \
preload("res://Scenes/Models/tomb_stone_model.tscn"), \
preload("res://Scenes/Models/sign_model.tscn"), \
